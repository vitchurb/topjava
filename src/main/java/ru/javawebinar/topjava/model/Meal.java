...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.BETWEEN_DATES, query = "SELECT m FROM Meal m WHERE m.user.id=:userId AND m.dateTime BETWEEN :datetimeFrom AND :datetimeTo ORDER BY m.dateTime DESC"),
})
@Entity
